...
//     await pool.query('SELECT * FROM payroll WHERE payroll_ID = ?', [payroll_ID]);
// }

// const addPayroll = async (payroll_ID,employeeID,hours_worked,leave_deductions,final_salary,performance) => {
//     await pool.query('INSERT INTO payroll (payroll_ID,employeeID,hours_worked,leave_deductions,final_salary,performance) SET (?,?,?,?,?,?)', [payroll_ID,employeeID,hours_worked,leave_deductions,final_salary,performance]);
// }
...
//     await pool.query('UPDATE payroll SET employeeID = ?, hours_worked = ?, leave_deductions = ?, final_salary = ?, performance = ? WHERE payroll_ID = ?', [employeeID,hours_worked,leave_deductions,final_salary,performance,payroll_ID]);
// }
